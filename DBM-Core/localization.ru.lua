...
L.AUTO_PRIVATEAURA_OPTION_TEXT		= "Воспроизводить звуковые оповещения DBM для приватных аур в этом бою. Приоритет звука: голосовой пакет, если он доступен, резервный - Воздушный горн (Air Horn)"
