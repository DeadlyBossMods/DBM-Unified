...
--L.GUILD_COMBAT_STARTED				= "Гильдия вступает в бой с %s"--Uncomment when updated, args have changed
...
--L.GUILD_BOSS_DOWN					= "Гильдия победила %s спустя %s!"--Uncomment when updated, args have changed
...
--L.GUILD_COMBAT_ENDED_AT				= "Гильдия вайпнулась на %s (%s) спустя %s."--Uncomment when updated, args have changed
