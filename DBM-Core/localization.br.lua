...
L.UPDATEREMINDER_HOTFIX				= "Sua versão do "..L.DBM.." contem cronômetros ou avisos incorretos para este chefe. Isso foi corrigido em uma versão mais recente ( ou alpha caso não exista versão estável mais recente disponível)"
...
L.TIME_TOO_SHORT 					= "O cronômetro de puxada deve ser maior que 3 segundos."
