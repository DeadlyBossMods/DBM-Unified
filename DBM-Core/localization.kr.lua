...
--L.GUILD_COMBAT_STARTED		= "길드가 %s 전투를 시작했습니다."--Uncomment when updated, args have changed
...
--L.GUILD_BOSS_DOWN			= "길드가 %s|1을;를; %s만에 물리쳤습니다!"--Uncomment when updated, args have changed
...
--L.GUILD_COMBAT_ENDED_AT		= "길드가 %s (%s)에서 %s만에 전멸했습니다."--Uncomment when updated, args have changed
