...
L.NEWS_UPDATE 						= "|h|c11ff1111Nouvelles|r|h : Cette mise à jour est essentiellement une réédition de la version 9.1.9 pour effacer une fausse détection de logiciel malveillant sur le hachage de la version précédente du fichier. En savoir plus à ce sujet |Hgarrmission:DBM:news|h|cff3588ff[ici]|r|h"
...
L.OPTION_CATEGORY_NAMEPLATES 		= "Plaques d'identité"
...
L.DBMLOOTREMINDER 				= "ATTENTION : Le mod tiers DBM-LootReminder est installé. Cet addon n'est plus compatible avec le client WoW Retail et causera des problèmes avec " .. L.DBM .. " et ne pourra pas envoyer de chronomètres de pull. Désinstallation de cet addon recommandée."
...
L.PLATER_NP_AURAS_MSG			= L.DBM .. " inclut une fonctionnalité avancée pour afficher les minuteries de recharge ennemies à l'aide d'icônes sur les plaques d'identité. Cela est activé par défaut pour la plupart des utilisateurs, mais pour les utilisateurs de Plater, il est désactivé par défaut dans les options de Plater, à moins que vous ne l'activiez. Pour tirer le meilleur parti de DBM (et de Plater), il est recommandé d'activer cette fonctionnalité dans Plater sous la section 'Buff Special'. Si vous ne voulez pas voir ce message à nouveau, vous pouvez également simplement désactiver complètement l'option 'Icônes de recharge sur les plaques d'identité' dans les options de désactivation globales de DBM ou dans les panneaux d'options des plaques d'identité."
...
L.AUTO_ANNOUNCE_TEXTS.targetsource		= ">%%s< incantation %s sur >%%s<"
L.AUTO_ANNOUNCE_TEXTS.targetcount		= "%s (%%s) sur >%%s<"
L.AUTO_ANNOUNCE_TEXTS.spell				= "%s"
L.AUTO_ANNOUNCE_TEXTS.incoming			= "%s debuff imminent"
L.AUTO_ANNOUNCE_TEXTS.incomingcount		= "%s debuff imminent (%%s)"
...
L.AUTO_TIMER_OPTIONS.cdnp 				= "Afficher le chronomètre sur la plaque d'identité uniquement pour le temps de recharge de $spell:%s"
L.AUTO_TIMER_OPTIONS.cdnpcount 			= "Afficher le chronomètre sur la plaque d'identité uniquement (avec compte) pour le temps de recharge de $spell:%s"
...
L.AUTO_TIMER_OPTIONS.nextnp 			= "Afficher le chronomètre sur la plaque d'identité uniquement pour le prochain $spell:%s"
L.AUTO_TIMER_OPTIONS.nextnpcount 		= "Afficher le chronomètre sur la plaque d'identité uniquement (avec compte) pour le prochain $spell:%s"
...
L.AUTO_YELL_OPTION_TEXT.shortposition 	= "Criee (avec position) lorsque vous êtes affecté par $spell:%s"
...
L.AUTO_NAMEPLATE_OPTION_TEXT 		= "Afficher les auras de la plaque d'identité pour $spell:%s en utilisant un addon de plaque d'identité compatible ou "..L.DBM
L.AUTO_NAMEPLATE_OPTION_TEXT_FORCED = "Afficher les auras de la plaque d'identité pour $spell:%s en utilisant uniquement "..L.DBM
