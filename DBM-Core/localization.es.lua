...
L.AUTO_ANNOUNCE_OPTIONS.incoming	= "Anunciar cuando $spell:%s tiene perjuicios entrantes"
L.AUTO_ANNOUNCE_OPTIONS.incomingcount		= "Anunciar (con contador) cuando $spell:%s tiene perjuicios entrantes"
...
L.AUTO_SPEC_WARN_TEXTS.soakcount	= "%s - ¡intercepta! (%%s)"
...
L.AUTO_SPEC_WARN_TEXTS.addscount	= "sbirros en breve - ¡cambia de objetivo! (%%s)"
...
L.AUTO_TIMER_TEXTS.intermission			= "Descanso"
L.AUTO_TIMER_TEXTS.intermissioncount	= "Descanso %%s"
...
L.AUTO_TIMER_OPTIONS.intermission		= "Mostrar temporizador para el siguiente descanso"
L.AUTO_TIMER_OPTIONS.intermissioncount	= "Mostrar temporizador (con contador) para el siguiente descanso"
...
L.AUTO_ICONS_OPTION_TARGETS_TANK_A		= "Establece iconos en objetivos de $spell:%s con tanque sobre cuerpo a cuerpo sobre prioridad a distancia y alternativa alfabética"
L.AUTO_ICONS_OPTION_TARGETS_TANK_R		= "Establece iconos en objetivos de $spell:%s con tanque sobre cuerpo a cuerpo sobre prioridad a distancia y alternativa lista de banda"
L.AUTO_ICONS_OPTION_TARGETS_MELEE_A		= "Establece iconos en objetivos de $spell:%s con prioridad cuerpo a cuerpo y alfabética"
L.AUTO_ICONS_OPTION_TARGETS_MELEE_R		= "Establece iconos en objetivos de $spell:%s con prioridad cuerpo a cuerpo y lista de banda"
L.AUTO_ICONS_OPTION_TARGETS_RANGED_A	= "Establece iconos en objetivos de $spell:%s con prioridad a distancia y alfabética"
L.AUTO_ICONS_OPTION_TARGETS_RANGED_R	= "Establece iconos en objetivos de $spell:%s con prioridad a distancia y lista de banda"
L.AUTO_ICONS_OPTION_TARGETS_ALPHA		= "Establece iconos en objetivos de $spell:%s con prioridad alfabética"
L.AUTO_ICONS_OPTION_TARGETS_ROSTER		= "Establece iconos en objetivos de $spell:%s con prioridad lista de banda"
