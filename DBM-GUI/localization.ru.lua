...
--L.FakeBWCallbacks			= "Использовать фейковый обработчик BigWigs, если он не установлен (полезно для использования WeakAuras, настроенных на работу только с BigWigs)"
