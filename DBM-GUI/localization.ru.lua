...
L.GroupOptionsExcludeIcon	= "Исключите опции 'Set Icon on' (он же 'установить значок на') из группировки по заклинаниям (они будут сгруппированы в категории 'icons', как и раньше)."
L.AutoExpandGrouppedSpells	= "Автоматическое расширение опций, сгруппированных по заклинаниям"
