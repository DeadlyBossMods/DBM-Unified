...
L.OverrideIcons 					= "Отключить маркировку значков для всех пользователей в рейде, включая меня (используйте переопределение вместо отключения, если Вы хотите, чтобы DBM делал маркировку на Ваших условиях)"
L.OverrideSay						= "Отключить облачка чата/сообщения СКАЗАТЬ для всех пользователей в рейде, включая меня"
