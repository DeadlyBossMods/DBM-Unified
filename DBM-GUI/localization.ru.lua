...
L.FilterTankSpec			= "Фильтровать предупреждения для роли танка, когда не в специализации танка<br/>(Примечание: отключение этого параметра не рекомендуется для большинства пользователей, поскольку теперь все предупреждения «таунта» включены по умолчанию)"
