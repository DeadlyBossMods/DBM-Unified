...
L.DoNotLogLFG				= "Не записывать LFG или LFR (содержимое очереди)"
L.LogCurrentRaids			= "Рейды текущего уровня"
L.LogTWRaids				= "Путешествие во времени или рейды времени Хроми"
L.LogTrivialRaids			= "Тривиальные рейды (ниже уровня персонажа)"
L.LogCurrentMPlus			= "Подземелья текущего уровня М+"
L.LogTWDungeons				= "Путешествие во времени или подземелья времени Хроми"
L.LogCurrentHeroic			= "Героические подземелья текущего уровня"
