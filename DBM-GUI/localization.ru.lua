...
L.SpamBlockNoSpecWarnSound			= "Не воспроизводить специальные звуки объявлений<br/>(по-прежнему разрешены голосовые пакеты, если они включены на панели голосовых предупреждений)"
