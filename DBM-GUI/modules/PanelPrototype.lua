...
local isBurningCrusadeClassic = (WOW_PROJECT_ID == WOW_PROJECT_BURNING_CRUSADE_CLASSIC)
...
do
	...
	local sounds = DBM_GUI:MixinSharedMedia3("sound", {
		...
		{ text = "BB Wolf: Run Away", value = (isRetail or isBurningCrusadeClassic) and 9278 or "Interface\\AddOns\\DBM-Core\\sounds\\ClassicSupport\\HoodWolfTransformPlayer01.ogg" },
		{ text = "Illidan: Not Prepared", value = (isRetail or isBurningCrusadeClassic) and 11466 or "Interface\\AddOns\\DBM-Core\\sounds\\ClassicSupport\\BLACK_Illidan_04.ogg" },
		...
		{ text = "Kil'Jaeden: Destruction", value = (isRetail or isBurningCrusadeClassic) and 12506 or "Interface\\AddOns\\DBM-Core\\sounds\\ClassicSupport\\KILJAEDEN02.ogg" },
