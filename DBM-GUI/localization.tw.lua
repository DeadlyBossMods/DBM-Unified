...
L.ReplacesSA1				= "替換特別提示 1 (個人的 'pvp拔旗') 聲音"
L.ReplacesSA2				= "替換特別提示 2 (每個人 '當心') 聲音"
L.ReplacesSA3				= "替換特別提示 3 (高優先級的 'airhorn') 聲音"
L.ReplacesSA4				= "替換特別提示 4 (高優先級的 '快跑') 聲音"
L.ReplacesCustom			= "替換特別提示 自定義使用者設置 (每個警告) 聲音 (不建議)"
